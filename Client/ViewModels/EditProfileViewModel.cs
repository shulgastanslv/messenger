...
public class EditProfileViewModel : ViewModelBase
{
    ...
    public EditProfileViewModel(HomeViewModel homeViewModel, UserStore userStore, HttpClient httpClient,
        NavigationStore navigationStore)
    {
        _userStore = userStore;

        NavigateToSettingsCommand = new NavigateCommand<SettingsViewModel>(new NavigationService<SettingsViewModel>(
            navigationStore, () => new SettingsViewModel(homeViewModel, userStore, httpClient, navigationStore)));
        ...
        NavigateToEditUserNameCommand = new NavigateCommand<EditUserNameViewModel>(
            new NavigationService<EditUserNameViewModel>(
                ...
                () => new EditUserNameViewModel(homeViewModel, userStore, httpClient, _editProfileNavigationStore)));
